...
namespace StockSale.App.Migrations
{
    ...
    [Migration("20241017200222_ProviderOrder Update")]
    partial class ProviderOrderUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockSale.App.Models.Domain.ProviderOrder", b =>
                {
                    ...
                    b.Property<string>("N_ProviderOrder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
