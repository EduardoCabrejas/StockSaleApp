...
namespace StockSale.App.Migrations
{
    ...
    [Migration("20240913195241_CuiltAdded")]
    partial class CuiltAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProviderOrderTurn", b =>
                {
                    b.Property<Guid>("ProviderOrdersId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TurnsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ProviderOrdersId", "TurnsId");

                    b.HasIndex("TurnsId");

                    b.ToTable("ProviderOrderTurn");
                });
            ...
            modelBuilder.Entity("ProviderOrderTurn", b =>
                {
                    b.HasOne("StockSale.App.Models.Domain.ProviderOrder", null)
                        .WithMany()
                        .HasForeignKey("ProviderOrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
